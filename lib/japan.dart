...
class _JapanState extends State<Japan> {
  ...
  static List questionPath1 = [
    "The general assks you to kill sai, Should we kill him?",
    "He died",
    "You teach him fluuter, now you guys are allies",
    "He dies",
    ""
  ];
  static List questionPath2 = [
    "Bye",
    "Sai attacks back, should we teach him flutter",
    "He is mad because you did not teach him flutter, Do you want to kill him",
    "He runs Away"
  ];
